...
<body>
	...
	<div id="flex">
		...
		<div id="top">
			<p id="exp">ルール説明</p>
			<p>ランダムで抽選されたトランプの数字に文字数が制限されるしりとりだ</p>
			<p>時間内に決められた回数分しりとりを回せればあなたの勝ち。</p>
			<p>・A,2,3 は 1~3文字の範囲で</p>
			<p>・4,5,6 は 4~6文字の範囲で</p>
			<p>・7,8,9 は 7~9文字の範囲で</p>
			<p>・10,J,Q,K は 10~13文字の範囲で答えられるぞ。</p>
			<p>ただし、範囲外の文字数で答えてしまうと即時、回数がリセットとなる。</p>
			<p>また、最後の文字が小文字(ぁ、ょ等)の場合は、大文字(あ、よ等)から始められるぞ。</p>
			<p>最後の文字が「ん、ー」の場合は、最後から2番目の文字から次のしりとりか始まるぞ。</p>
			<p>最後に、ひらがなとカタカナは互換性があるぞ。</p>
		</div>
